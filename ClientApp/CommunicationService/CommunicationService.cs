...
namespace ClientApp
{
    class CommunicationService
    {
        ...
        public CommunicationService(String address)
        {
            ...
            NetTcpBinding srvBinding = new NetTcpBinding();
            srvBinding.Security.Transport.ClientCredentialType = TcpClientCredentialType.Certificate;

            this.Host = new ServiceHost(typeof(CommunicationProvider));
            this.Host.AddServiceEndpoint(typeof(ICommunication), srvBinding, address);
